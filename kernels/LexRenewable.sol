...
contract LexRenewable is RoyaltySplitter, AdaptiveKernelBase {
    ...
    /// @param ageMonths  Months since renewable-energy certificate issued
    function checkRenewable(uint256 ageMonths) external payable returns (uint256 fused) {
        ...
        if (ageMonths > MAX_CERT_AGE_MONTHS) {
