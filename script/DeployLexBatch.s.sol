...
contract DeployLexBatch is Script {
    ...
    function run() external {
        ...
        address lexSAR = factory.deployKernel(
            keccak256("LexSAR-v1"),
            bytecode,
            args
        );
        ...
        args = abi.encode(BENEFICIARY);
        address lexNFT = factory.deployKernel(
            keccak256("LexNFT-v1"),
            bytecode,
            args
        );
        ...
        args = abi.encode(BENEFICIARY);
        address lexGrid = factory.deployKernel(
            keccak256("LexGrid-v1"),
            bytecode,
            args
        );
        ...
        args = abi.encode(BENEFICIARY);
        address lexESG = factory.deployKernel(
            keccak256("LexESG-v1"),
            bytecode,
            args
        );
        ...
        args = abi.encode(BENEFICIARY);
        address lexShip = factory.deployKernel(
            keccak256("LexShip-v1"),
            bytecode,
            args
        );
