//! KL-242-VolumeNormalisation – copyright 2025 Lex Libertatum Trust – Per-Decision Royalty Licence
...
pub fn decide(report: &Report) -> (Decision, Certificate) {
    ...
    // DENY if LUFS > -9
    let decision = if report.score >= -9 { Decision::Certified } else { Decision::Rejected };
