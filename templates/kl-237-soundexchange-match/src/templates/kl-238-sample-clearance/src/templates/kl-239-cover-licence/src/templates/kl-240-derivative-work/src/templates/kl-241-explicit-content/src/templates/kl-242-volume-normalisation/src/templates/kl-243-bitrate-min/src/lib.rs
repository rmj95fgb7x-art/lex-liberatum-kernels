//! KL-243-BitrateMin – copyright 2025 Lex Libertatum Trust – Per-Decision Royalty Licence
...
pub fn decide(report: &Report) -> (Decision, Certificate) {
    ...
    // DENY if < 320 kbps
    let decision = if report.score >= 320 { Decision::Certified } else { Decision::Rejected };
