//! KL-701-SpaceDebrisCollision – copyright 2025 Lex Libertatum Trust – Per-Decision Royalty Licence
...
pub fn decide(report: &Report) -> (Decision, Certificate) {
    ...
    // DENY if collision probability > 1×10⁻⁵
    let decision = if report.score <= 100_000 { Decision::Certified } else { Decision::Rejected };
