//! KL-703-PlanetaryProtectionCategory – copyright 2025 Lex Libertatum Trust – Per-Decision Royalty Licence
...
pub fn decide(report: &Report) -> (Decision, Certificate) {
    ...
    // DENY if planetary protection category != 3
    let decision = if report.score == 3 { Decision::Certified } else { Decision::Rejected };
