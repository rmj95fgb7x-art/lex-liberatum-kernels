//! KL-202-EncryptionLevel – copyright 2025 Lex Libertatum Trust – Per-Decision Royalty Licence
...
pub fn decide(report: &Report) -> (Decision, Certificate) {
    ...
    // DENY if AES < 256
    let decision = if report.score == 256 { Decision::Certified } else { Decision::Rejected };
